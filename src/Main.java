...
public class Main {
    ...
    public static int[] health = {800, 250, 250, 250, 200};
    public static int[] damdages = {50, 20, 20, 20, 10};
    ...
    public static int medicPlayer (int playerIndex) {
        ...
        if (health[playerIndex] > 0 && health[4] > 0) {
            return damdages[4] + health[playerIndex];
        }
    ...
    public static int playerHit(int playerIndex) {
        if (hitTypes[0].equals(hitTypes[playerIndex])) {
            ...
            System.out.println(hitTypes[playerIndex]
                    ...
                    damdages[playerIndex] * randomNumber);
            return health[0] - damdages[playerIndex] * randomNumber;
        } else {
            return health[0] - damdages[playerIndex];
        }

    }

    public static int bossHit(int playerIndex) {
        return health[playerIndex] - damdages[0];
    }
